...
#define GNOME_APP_TYPE_CONFIG            (gnome_app_config_get_type ())
#define GNOME_APP_CONFIG(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), GNOME_APP_TYPE_CONFIG, GnomeAppConfig))
#define GNOME_APP_CONFIG_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass),  GNOME_APP_TYPE_CONFIG, GnomeAppConfigClass))
#define GNOME_APP_IS_CONFIG(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GNOME_APP_TYPE_CONFIG))
#define GNOME_APP_IS_CONFIG_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass),  GNOME_APP_TYPE_CONFIG))
#define GNOME_APP_CONFIG_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj),  GNOME_APP_TYPE_CONFIG, GnomeAppConfigClass))
