...
void			gnome_app_query_set 			(GnomeAppQuery *query, gchar *arg_name, gchar *arg_value);
const gchar *		gnome_app_query_get 			(GnomeAppQuery *query, gchar *arg);

/*This is not good,  ocs based */
GnomeAppQuery *         gnome_app_query_new_with_services	(gchar *services, gchar *operation);
